...
namespace LojaRoupas.Areas.Admin.Controllers
{
    ...
    public class AdminRoupasController : Controller
    {
        ...
        {
            return View(await _context.Roupas.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Tamanho,Cor,Material,Preco,Estoque,Descricao,Genero,DataDeCadastro,CategoriaId,MarcaId,Ativo,Lancamento,Promocao,PrecoPromocao")] Roupa roupa, IFormFile imagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Editar(Guid id, [Bind("Id,Nome,Tamanho,Cor,Material,Preco,Estoque,Descricao,Genero,CategoriaId,MarcaId,Ativo,ImagemUrl,Lancamento,Promocao,PrecoPromocao")] Roupa roupa, IFormFile imagem)
        {
            if (id != roupa.Id)
            {
                return NotFound();
